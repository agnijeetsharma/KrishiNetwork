...
export const CropCard= (data) => {
  console.log(data)
  const { cropImage, like, description, createdAt, updatedAt, title }=data.crop
    ...
    <div className="mt-20 h-screen bg-gray-100 p-5">
      <div className="bg-white shadow-xl rounded-lg p-6 h-96 w-80 mx-auto">
        ...
        <div className="flex justify-around mt-6">
          ...
          <button className="flex items-center gap-2 bg-red-500 text-white py-2 px-4 rounded-lg shadow hover:bg-red-400 transition">
