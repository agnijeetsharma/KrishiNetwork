...
const cropAddedByBuyer = AsyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, buyer, "Crop added successfully"));
});
...
const getAllBuyerCrop = AsyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(400, crops, "all crop got successfully"));
});
const removeCropAddedByBuyer = AsyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, buyer, "Crop removed successfully"));
});
